...
export const myProfileText2 = "Commited software developer and teacher with a passion for building rubust and efficient applications, and inspiring young minds into the world of teachnology. Having a firm understanding of fundamental software engineering principles and programming languages such as Python, TypeScript and Go. Having a commended team spirit, a love for the teaching vocation, and commitment to continuous learning and inprovement."
...
export const myExperience: ExperienceType[] = [
  {
    ...
    activities: {
      ...
      highlights: [
        ...
        "Led as agile coach for one of the company's major projects, which entailed leading scrum meetings, grooming and planning sessions",
        "Ensured on-time delivery of high-quality code",
  ...
  },
  {
    ...
    title: "Lecturer",
    company: "HIBMAT University Institute Buea",
    activities: {
      overview: "Computer graphics and Design instructor for HND students",
      highlights: [
        "Guided students through hands on experience and exercises in Graphics Design and video editing",
        "Led students to the mastery of cocepts and principles of digital imaging and photography.",
      ]
    }
  },
  {
