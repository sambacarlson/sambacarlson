import { Experience, Education, Reference, Skill } from "@/types/resumeTypes"
...
export const myExperience: Experience[] = [
  {
    ...
    activities: {
      ...
      highlights: [
        ...
        "Used google firebase as backend-as-a-service for some applications. Also used firestore for storage and firebase auth for authentication",
  ...
  // },
  {
    ...
    company: "-",
    activities: {
      overview: "Guided newcomers into the world of software engineering, by their requests, counselling them on the prospective career options and recommending paths to take to actualize their dreams",
      highlights: [
        ...
        "Councelled students on effective study methods and habits to develope to succeed and thrive in school and in the world of engineering",
...

  {
    ...
    activities: {
      overview: "Satisfactorily conpleted a  required academic internship at the company, extending  my stay to learn, improve and participate.",
      highlights: [
        "Satisfactorily collaborated with teamates, passionately learning, contributing, asking lots of questions and taking notes",
        ...
        "Contributed one of the mobile apps developed by the company using fluter. wrote the SRS for the app with another intern after detailed breifing by the project lead. Also built some pages using the flutter SDK"
      ]
    }
  },
  {
...
export const myEducation: Education[] = [
  {
    ...
    details: "Obtained and top-up Bachelor of Technology degree in Software Engineering with a GPA of 3.76 on 4.0"
  },
  {
