...
export default function Resume() {
  ...
  return (
    <main className="flex flex-col items-center text-black w-full max-w-[750px] min-h-[1000px] mx-auto font-gothic leading-6 border border-stone-100">
      ...
      <h4
        onClick={downloadPDF}
        className="print:hidden fixed right-[5%] top-10 rounded-lg py-2 px-4 hover:cursor-pointer z-20 border-2 text-sm border-yellow-400 text-yellow-400 bg-emerald-900 animate-pulse hover:animate-none duration-300 hover:border-white active:border-yellow-400 active:bg-emerald-700"
      >
        Download PDF
      </h4>
    ...
    <div className="grid grid-cols-5 my-2">
      ...
      <div className="col-span-5 tablet:col-span-4 flex flex-col">
        ...
        <ul className="list-disc list-outside pl-[0.9em]">
          {exp.activities.highlights.map((item: string, i: number) => (
...
const Reference = ({ reference }: { reference: { name: string; org: string; email: string } }) => {
  return (
    <div className="flex flex-col">
