...
const Footer = ({ profile }: { profile: ProfileType }) => {
  const [[theme, themeLight], setThemeColor] = React.useState<[string, string]>(["default", "defaultLight"]);

  React.useEffect(() => {
    setThemeColor(getThemeColor(profile))
  }, []);
  return (
    <div className="p-3 tablet:py-5 tablet:px-16 min-h-[24vh] grid grid-cols-3 justify-center text-default bg-defaultLight">
      <div className="col-span-3 tablet:col-span-1 flex flex-col space-y-4">
        <h3 className="text-xl font-semibold w-full border-b py-4" style={{ borderBlockEndColor: theme }}>
          Contact / Address
        </h3>
      ...
      <div className="col-span-3 tablet:col-span-1 flex flex-col space-y-4">
        <h3 className="text-xl font-semibold border-b w-full py-4" style={{ borderBlockEndColor: theme }} >Work / Links</h3>
      ...
      <div className="col-span-3 tablet:col-span-1 flex flex-col space-y-4">
        <h3 className="text-xl font-semibold border-b w-full py-4" style={{ borderBlockEndColor: theme }} >
          Social media
        </h3>
