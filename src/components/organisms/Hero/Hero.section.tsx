...
const Hero = () => {
  return (
    <div className="flex-1 flex flex-col pt-2 tablet:flex-row items-center justify-center space-y-2 tablet:space-y-0">
      ...
      <div className="flex-2 flex flex-col space-y-1 justify-center tablet:pr-4 w-[85vw] tablet:w-[45vw]">
        ...
        <p className="">{devIntro}</p>

        <div className="max-w-[220px]">
          <Link
            href="https://wa.me/237677964952"
            target="new"
      ...
      <div className="hidden tablet:flex flex-1 ">
        <Image
          ...
          height={500}
          alt="Carlson"
          className="w-auto h-[50vh] transform -scale-x-100"
        />
      </div>
    </div>
  );
